...
class ResNet34_3D(nn.Module):
    def __init__(self, block=BasicBlock, layers=[3, 4, 6, 3], num_classes=4):
...
def inference():
    ...
    model_path = r"C:\Users\PC\PycharmProjects\thu_xwh\Codes\Model\unicom20251018\f1_resnet34_fold5\best_model.pth"
    ...
    # 初始化模型
    model = ResNet34_3D(num_classes=4).to(device)
    try:
    ...
    for case_id in cases:
        ...
        output_path = data_dir / f"{case_id}_f1_resnet34_fold5_gt_5015.npy"
        try:
